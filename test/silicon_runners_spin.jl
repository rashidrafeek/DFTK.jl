...
function run_silicon_redHF_compare(T; Ecut=5, test_tol=1e-6, n_ignored=0, grid_size=15, scf_tol=1e-6)
    ...
    model_collinear = model_reduced_hf(Array{T}(silicon.lattice), [Si => silicon.positions],
                              temperature=0.05, spin_polarization=:collinear)
    ...
    scfres_none = self_consistent_field(basis_none, tol=scf_tol, n_bands=n_bands)
    scfres_collinear = self_consistent_field(basis_collinear, tol=scf_tol, n_bands=n_bands)
...
function run_silicon_redHF_none(T; Ecut=5, test_tol=1e-6, n_ignored=0, grid_size=15, scf_tol=1e-6)
    ...
    scfres = self_consistent_field(basis, maxiter=10, callback=scf_debug_callback, tol=scf_tol, n_bands=n_bands)
